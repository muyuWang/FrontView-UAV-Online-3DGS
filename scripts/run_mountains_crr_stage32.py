#!/usr/bin/env python3
"""Test responsibility-consistent adaptive footprint area on Mountains."""
...
runner.DEFAULT_OUTPUT = runner.ROOT / "Logs_mountains_crr_stage32_8_13"
...
runner.VARIANTS = {
    "A_owner_area_real": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_owner_area",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
    "B_owner_area_matched_shuffled": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_owner_area_shuffled",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
}
