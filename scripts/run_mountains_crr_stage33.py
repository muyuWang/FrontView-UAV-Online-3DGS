#!/usr/bin/env python3
"""Test causal residual rate-distortion footprints on Mountains."""
...
runner.DEFAULT_OUTPUT = runner.ROOT / "Logs_mountains_crr_stage33_8_13"
...
runner.VARIANTS = {
    "A_residual_rd_real": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_residual_rd",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
    "B_residual_rd_matched_shuffled": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_residual_rd_shuffled",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
}
