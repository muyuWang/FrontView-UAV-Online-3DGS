#!/usr/bin/env python3
"""Run full PanoAir TGBR spectral-residency controls on GPUs 4-7."""
...
TAG = "tgbr_spectral_residency_full_20260810"
RUNS = (
    (
        "baseline",
        4,
    ...
    (
        "fixed16_control",
        6,
        "configs/frontview_uav/panoair_tgbr_residency_fixed16_full.yaml",
        "PanoAir-tgbr-residency-fixed16-full",
    ),
    (
        "ebrr_zero_control",
        7,
        "configs/frontview_uav/panoair_tgbr_residency_ebrr_control_full.yaml",
        "PanoAir-tgbr-residency-ebrr-control-full",
    ),
)
