#!/usr/bin/env python3
"""Screen record-based canonical ray responsibility on Mountains."""
...
runner.DEFAULT_OUTPUT = runner.ROOT / "Logs_mountains_crr_stage19_8_13"
...
runner.VARIANTS = {
    ...
    "C_canonical_record": {
        "far_field": {
            ...
            "ray_atlas_shuffle_evidence": False,
            "ray_atlas_coordinate_mode": "canonical_world",
            "ray_atlas_competition_mode": "continuous_record",
        },
    },
    "D_record_shuffled": {
        "far_field": {
