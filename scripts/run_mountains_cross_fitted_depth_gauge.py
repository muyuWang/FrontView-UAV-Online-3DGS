#!/usr/bin/env python3
"""Run cross-fitted track/depth gauge controls on Mountains."""
...
runner.DEFAULT_OUTPUT = (
    runner.ROOT / "Logs_mountains_far_depth_goal_8_13/cross_fitted_depth_gauge_620"
)


def gauge(*, shuffle_binding=False, action="fuse"):
    return {
        "enabled": True,
        "history_frames": 4,
        "max_features": 2048,
...
runner.VARIANTS = {
    "A_real_observe": {
        "causal_metric_birth": gauge(action="observe_only"),
    },
    "B_real_gauge": {
        "causal_metric_birth": gauge(),
    },
    "C_shuffled_observe": {
        "causal_metric_birth": gauge(
    ...
    "D_shuffled_gauge": {
        "causal_metric_birth": gauge(shuffle_binding=True),
    },
}
