#!/usr/bin/env python3
"""Test one-sided residual rate-distortion detail protection on Mountains."""
...
runner.DEFAULT_OUTPUT = runner.ROOT / "Logs_mountains_crr_stage34_8_13"
...
runner.VARIANTS = {
    "A_residual_detail_real": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_residual_rd_detail",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
    "B_residual_detail_matched_shuffled": {
        "far_field": {
            **COMMON,
            "footprint_trust_mode": "certificate_residual_rd_detail_shuffled",
        },
        "sampling": {"selection_mode": "adaptive_log_depth_random"},
    },
}
